...
export type RocketsInfoQueryVariables = Exact<{ [key: string]: never }>;

export type RocketsInfoQuery = { __typename?: "Query" } & {
  rockets?: Maybe<
    Array<
      Maybe<
        { __typename?: "Rocket" } & Pick<
          ...
          | "flickr_images"
        > & {
            payload_weights?: Maybe<
              Array<
                Maybe<
                  { __typename?: "RocketPayloadWeight" } & Pick<
                    RocketPayloadWeight,
                    "kg"
                  >
                >
...
export type ShipsInfoQueryVariables = Exact<{ [key: string]: never }>;

export type ShipsInfoQuery = { __typename?: "Query" } & {
  ships?: Maybe<
    Array<
      Maybe<
...
export type MissionsInfoQueryResult = Apollo.QueryResult<
  ...
  MissionsInfoQueryVariables
>;
export const RocketsInfoDocument = gql`
  query RocketsInfo {
    rockets {
      id
      rocket_id
...
/**
 * __useRocketsInfoQuery__
 *
 * To run a query within a React component, call `useRocketsInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useRocketsInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRocketsInfoQuery({
 *   variables: {
 *   },
 * });
 */
export function useRocketsInfoQuery(
  baseOptions?: Apollo.QueryHookOptions<
    RocketsInfoQuery,
    RocketsInfoQueryVariables
  >
) {
  return Apollo.useQuery<RocketsInfoQuery, RocketsInfoQueryVariables>(
    RocketsInfoDocument,
    baseOptions
  );
}
export function useRocketsInfoLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    RocketsInfoQuery,
    RocketsInfoQueryVariables
  >
) {
  return Apollo.useLazyQuery<RocketsInfoQuery, RocketsInfoQueryVariables>(
    RocketsInfoDocument,
    baseOptions
  );
}
export type RocketsInfoQueryHookResult = ReturnType<typeof useRocketsInfoQuery>;
export type RocketsInfoLazyQueryHookResult = ReturnType<
  typeof useRocketsInfoLazyQuery
>;
export type RocketsInfoQueryResult = Apollo.QueryResult<
  RocketsInfoQuery,
  RocketsInfoQueryVariables
>;
export const ShipsInfoDocument = gql`
  query ShipsInfo {
    ships {
      ship_id
      ship_name
...
/**
 * __useShipsInfoQuery__
 *
 * To run a query within a React component, call `useShipsInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useShipsInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useShipsInfoQuery({
 *   variables: {
 *   },
 * });
 */
export function useShipsInfoQuery(
  baseOptions?: Apollo.QueryHookOptions<ShipsInfoQuery, ShipsInfoQueryVariables>
) {
  return Apollo.useQuery<ShipsInfoQuery, ShipsInfoQueryVariables>(
    ShipsInfoDocument,
    baseOptions
  );
}
export function useShipsInfoLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ShipsInfoQuery,
    ShipsInfoQueryVariables
  >
) {
  return Apollo.useLazyQuery<ShipsInfoQuery, ShipsInfoQueryVariables>(
    ShipsInfoDocument,
    baseOptions
  );
}
export type ShipsInfoQueryHookResult = ReturnType<typeof useShipsInfoQuery>;
export type ShipsInfoLazyQueryHookResult = ReturnType<
  typeof useShipsInfoLazyQuery
>;
export type ShipsInfoQueryResult = Apollo.QueryResult<
  ShipsInfoQuery,
  ShipsInfoQueryVariables
>;
